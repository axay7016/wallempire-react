...
export default function ProductCategory({ navigation }) {
    ...
    const getDescItem = (item) => {
        navigate(`/productdetails?id=${item._id}&category=main`)
        // window.open(`/productdetails?id=${item._id}`, '_blank')
    }

    const getProduct = async () => {
        const productRes = await axios.get(process.env.REACT_APP_SERVER_API + `/product?page=${0}&limit=${20}&sub_category_id=` + subcategory, {
            headers: {
        ...
        if (productRes.status === 200) {
            ...
            const categoryRes = await axios.get(process.env.REACT_APP_SERVER_API + "/sub-category?subCatgory_id=" + subcategory, {
                headers: {
                    authorization: 'Basic d2FsbGVtcGlyZTp3YWxsZW1waXJl'
                }
            })
            if (categoryRes.status === 200) {
                setcategory(categoryRes.data.data.category[0])
            }
        }
    }
    const getPaginatedProducts = async () => {
        const productRes = await axios.get(process.env.REACT_APP_SERVER_API + `/product?page=${page}&limit=${limit}&sub_category_id=` + subcategory, {
            headers: {
                authorization: 'Basic d2FsbGVtcGlyZTp3YWxsZW1waXJl'
            }
        })
        ...
        <StyleRoot>
            <div ref={ref}>
                ...
                {mobileScreenStatus == false ?
                    <div className={model ? "model open pt-0" : "model"} style={styles.fadeIn}>
                        <div className={(tempItem2 != '' && tempItem3 != '' && tempItem4 != '') ? 'grid grid-cols-5 gap-4 pl-5 pr-5' : 'grid grid-cols-4 gap-4'}>
                            ...
                            </div>
                            {
                                (tempItem2 != '' && tempItem3 != '' && tempItem4 != '') ?
                                    <div className=' max-h-128 grid sm:flex md:grid gap-3'>
                                        {/* <LazyLoadImage className='opacity-100 hover:opacity-95 transition duration-100 ease-in-out object-contain rounded-md cursor-pointer h-52 w-72 relative bg-fixed bg-center bg-cover bg-no-repeat' style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem2})` }} src={tempItem2} onClick={() => setImage(tempItem2)} alt="No Image Available" />
                                        <LazyLoadImage className='opacity-100 bg-opacity-0 hover:opacity-95 transition duration-100 ease-in-out object-contain rounded-md cursor-pointer h-52 w-72 relative bg-fixed bg-center bg-cover bg-no-repeat' style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem3})` }} src={tempItem3} onClick={() => setImage(tempItem3)} alt="No Image Available" />
                                        <LazyLoadImage className='opacity-100 hover:opacity-95 transition duration-100 ease-in-out object-contain rounded-md cursor-pointer h-40 w-72 relative bg-fixed bg-center bg-cover bg-no-repeat' style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem4})` }} src={tempItem4} onClick={() => setImage(tempItem4)} alt="No Image Available" /> */}
                                        <ProgressiveImage src={tempItem2} placeholder={'tiny-image.jpg'}>
                                            {(src, loading) => (
                                                loading ?
                                                    ...
                                                    :
                                                    <img
                                                        className={`image${loading ? " loading" : " loaded opacity-100 hover:opacity-95 transition duration-100 ease-in-out object-contain rounded-md cursor-pointer h-52 w-72 relative bg-fixed bg-center bg-cover bg-no-repeat"}`}
                                                        style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem2})` }}
                                                        src={tempItem2}
                                                        alt={productName}
                                                        width="700"
                                                        height="465"
                                        ...
                                        <ProgressiveImage src={tempItem3} placeholder={'tiny-image.jpg'}>
                                            {(src, loading) => (
                                                loading ?
                                                    <div className="flex justify-center items-center h-52 w-72">
                                                        <div className="spinner-border animate-spin inline-block w-8 h-8 border-4 rounded-full text-yellow-300 mb-4" role="status">
                                                    ...
                                                    <img
                                                        className={`image${loading ? " loading" : " loaded opacity-100 hover:opacity-95 transition duration-100 ease-in-out object-contain rounded-md cursor-pointer h-52 w-72 relative bg-fixed bg-center bg-cover bg-no-repeat"}`}
                                                        style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem3})` }}
                                                        src={tempItem3}
                                                        alt={productName}
                                                        width="700"
                                                        height="465"
                                        ...
                                        <ProgressiveImage src={tempItem4} placeholder={'tiny-image.jpg'}>
                                            {(src, loading) => (
                                                loading ?
                                                    <div className="flex justify-center items-center h-52 w-72">
                                                        <div className="spinner-border animate-spin inline-block w-8 h-8 border-4 rounded-full text-yellow-300 mb-4" role="status">
                                                    ...
                                                    <img
                                                        className={`image${loading ? " loading" : " loaded opacity-100 hover:opacity-95 transition duration-100 ease-in-out object-contain rounded-md cursor-pointer h-52 w-72 relative bg-fixed bg-center bg-cover bg-no-repeat"}`}
                                                        style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem4})` }}
                                                        src={tempItem4}
                                                        alt={productName}
                                                        width="700"
                                                        height="465"
                            ...
                            <section className="col-span-5 pl-4">
                                <Carousel autoPlay={false} shouldResetAutoplay={true} pauseOnHover={true} responsive={responsive} className=''>
                                    {
                                        product?.map((item, index) => {
                                            return (
                                                <div className="flex h-44 items-center mr-4" key={index} onClick={() => getItem(item)}>
                                                    <figure className="relative sm:max-w-xs cursor-pointer h-44 w-full">
                                                        <ProgressiveImage src={item.postImage1} placeholder={'tiny-image.jpg'}>
                                                            {(src, loading) => (
                                                                loading ?
                                                                    ...
                                                                    :
                                                                    <img
                                                                        className={`image${loading ? " loading" : " loaded opacity-100 hover:opacity-95 transition duration-100 ease-in-out rounded-lg shadow-xl w-full h-44 object-contain"}`}
                                                                        src={item.postImage1}
                                                                        alt={productName}
                                                                        width="700"
                                                                        height="465"
                                                        ...
                                                        {/* <LazyLoadImage src={item.postImage1} layout="fill" className="opacity-100 hover:opacity-95 transition duration-100 ease-in-out rounded-lg shadow-xl w-full h-44 object-contain" /> */}
                                                    </figure>
                                                </div>
                                            )
                                        }
                    ...
                    :
                    <div className={model ? "model open p-5" : "model"} style={styles.fadeIn}>
                        <div className='grid gap-4'>
                            ...
                            </div>
                            {
                                (tempItem2 != '' && tempItem3 != '' && tempItem4 != '') ?
                                    <>
                                        <div className={windowSize.innerWidth < 1000 ? 'grid grid-cols-2 overflow-x-auto gap-4 items-end' : 'grid grid-cols-4 overflow-x-auto gap-4 items-end'}>
                                            <ProgressiveImage src={initImage} placeholder={'tiny-image.jpg'}>
                                                {(src, loading) => (
                                                    loading ?
                                                        <div className="flex justify-center items-center h-28 md:h-40">
                                                            <div className="spinner-border animate-spin inline-block w-8 h-8 border-4 rounded-full text-yellow-300 mb-4" role="status">
                                                            </div>
                                                        </div>
                                                        :
                                                        <img
                                                            className={`image${loading ? " loading" : " loaded object-contain rounded-md cursor-pointer h-28 md:h-40 w-full relative bg-fixed bg-center bg-cover bg-no-repeat"}`}
                                                            style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${initImage})`, ...styles.fadeIn }}
                                                            src={initImage}
                                                            alt={productName}
                                            ...
                                            <ProgressiveImage src={tempItem2} placeholder={'tiny-image.jpg'}>
                                                {(src, loading) => (
                                                    loading ?
                                                        ...
                                                        <img
                                                            className={`image${loading ? " loading" : " loaded object-contain rounded-md cursor-pointer h-28 md:h-40 w-full relative bg-fixed bg-center bg-cover bg-no-repeat"}`}
                                                            style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem2})`, ...styles.fadeIn }}
                                                            src={tempItem2}
                                                            alt={productName}
                                                            onClick={() => setImage(tempItem2)}
                                                        />
                                            ...
                                            <ProgressiveImage src={tempItem3} placeholder={'tiny-image.jpg'}>
                                                {(src, loading) => (
                                                    loading ?
                                                        ...
                                                        <img
                                                            className={`image${loading ? " loading" : " loaded object-contain rounded-md cursor-pointer h-28 md:h-40 w-full relative bg-fixed bg-center bg-cover bg-no-repeat"}`}
                                                            style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem3})`, ...styles.fadeIn }}
                                                            src={tempItem3}
                                                            alt={productName}
                                                            onClick={() => setImage(tempItem3)}
                                                        />
                                            ...
                                            <ProgressiveImage src={tempItem4} placeholder={'tiny-image.jpg'}>
                                                {(src, loading) => (
                                                    loading ?
                                                        ...
                                                        <img
                                                            className={`image${loading ? " loading" : " loaded object-contain rounded-md cursor-pointer h-28 md:h-40 w-full relative bg-fixed bg-center bg-cover bg-no-repeat"}`}
                                                            style={{ backgroundImage: `linear-gradient(rgba(160,160,160, 0.7), rgba(160,160,160, 0.7)), url(${tempItem4})`, ...styles.fadeIn }}
                                                            src={tempItem4}
                                                            alt={productName}
                                                            onClick={() => setImage(tempItem4)}
                                                        />
                ...
                <div className='pl-4 pr-4 md:pt-24'>
                    <div className='grid md:place-items-center'>
                        <div className='mt-20 md:mt-5 md:w-1/2 text-center mb-10 align-middle'>
